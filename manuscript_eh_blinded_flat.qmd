...
**Results:** FAI showed substantial agreement with WHO PTA-4 classification (weighted κ = 0.93). Agreement was 98.4% in clear cases, where crisp classification is uncontroversial; in borderline cases within ±5 dB of a severity boundary — 18.8% of test ears — the system returned graded membership rather than a forced binary label (84.9% agreement with the crisp grade, reflecting the designed reclassification of ambiguous thresholds). At the normal–mild transition, membership grades continuously (e.g., 26 dB: Normal μ = 0.16, Mild μ = 0.40) instead of flipping at 26 dB.

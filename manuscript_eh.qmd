...
![Overlapping trapezoidal membership functions for six hearing loss severity categories. The NHANES-optimised boundaries show an ~8 dB rightward shift relative to classic WHO thresholds, with controlled 2–3 dB overlap at each transition.](figures/fig1_membership_functions.png){#fig-1 width=90%}
